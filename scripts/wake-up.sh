...
# bedtime.sh's phase 3: starts getty@tty1.service, which triggers the
# autologin -> startx -> BasiliskII chain.
#
# Usage:
#   ./wake-up.sh
...
chimebox_ssh_interactive "sudo systemctl start getty@tty1.service"
